        ...
        while ($row = $viewBelt->fetch(PDO::FETCH_ASSOC))
        {
            ...
            echo'
                <tr>
                    ...
                    <td>'.$width.'</td>
                    <td>'.$type.'</td>
                    <td><a href="deleteBelt.php?id='.$row['id'].'">DeleteGET</a></td>
                    <td><form method="POST" action="deleteBelt.php"><input type="hidden" value="'.$row['id'].'" name="id"/><input type="submit" value="Remove"/></form></td>
                </tr>
            ';
